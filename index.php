      ...
      <section class="tp-slider-area p-relative z-index-1 fix">
         <div class="tp-slider-active-5s swiper-containers">
            <div class="swiper-wrappers">
               <div class="tp-slider-item-5 scene tp-slider-height-5 swiper-slide d-flex align-items-center"
                     ...
                     <div class="row align-items-center">
                        <div class="col-xxl-7 col-xl-7 col-lg-6">
                           <div class="tp-slider-content-5 p-relative z-index-1">
                              ...
                              <h3 class="tp-slider-title-5">Boutique <br>Intime</h3>

                              <div class="tp-slider-btn-5" >
                                 <a href="shop-category.php" class="tp-btn-green" style="background-color: #E44C76;" onmouseover="this.style.backgroundColor='#C50E40'" onmouseout="this.style.backgroundColor='#E44C76'">Commence ici</a>
                              </div>
                           </div>
                        </div>
                        <div class="col-xxl-5 col-xl-5 col-lg-6">
                           <div class="tp-slider-thumb-wrapper-5 p-relative">
                              <div class="tp-slider-thumb-shape-5 one d-none d-sm-block">
                                 <img data-depth="0.1" class="layer offer" src="assets/img/slider/5/shape/offer.png"
                                    alt="">
                              </div>
                              <div class="tp-slider-thumb-5 main-img">
                                 <img data-depth="0.2" class="layer" src="assets/img/slider/5/slider-2-final.png"
                                    alt="">
...
<!-- Section Produits UrDesire (avec boutons complets) -->
    ...
    <div class="row align-items-end">
      <div class="col-xl-6 col-lg-5">
        <div class="tp-section-title-wrapper-5 mb-45 text-center text-lg-start">
          ...
          <h3 class="tp-section-title-5">Produits Phares</h3>
        </div>
      </div>
    </div>
    <div class="row">
      ...
      <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
        <div class="tp-product-item-5 p-relative white-bg mb-30">
          
          <!-- Badge nouveau -->
          
          <div class="tp-product-thumb-5 w-img fix mb-15">
            <a href="product-details.php?id=1">
              <img src="assets/img/product/kit.png" alt="Kit détente intime">
            </a>
            <div class="tp-product-action-2 tp-product-action-5 tp-product-action-greenStyle">
              <div class="tp-product-action-item-2 d-flex flex-column">
                ...
                <!-- Wishlist -->
                <button type="button" 
                        class="tp-product-action-btn-2 tp-product-add-wishlist-btn" 
                ...
                <!-- Vue rapide -->
                <!-- <button type="button" class="tp-product-action-btn-2 tp-product-quick-view-btn" title="Vue rapide" data-bs-toggle="modal" data-bs-target="#productQuickViewModal">
                  <i class="fa fa-eye"></i>
                </button> -->
              </div>
            </div>
          ...
          <div class="tp-product-content-5">
            <h3 class="tp-product-title-5">
              <a href="product-details.php">Kit détente intime</a>
            </h3>
            <div class="tp-product-price-wrapper-5">
              <span class="tp-product-price-5 new-price">12 500 FCFA</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="tp-product-item-5 p-relative white-bg mb-30">
          ...
          <div class="tp-product-thumb-5 w-img fix mb-15">
            <a href="product-details.php?id=2">
              <img src="assets/img/product/6.png" alt="Livre : L’art du plaisir">
            </a>
            <div class="tp-product-action-2 tp-product-action-5 tp-product-action-greenStyle">
              <div class="tp-product-action-item-2 d-flex flex-column">
          ...
          <div class="tp-product-content-5">
            <h3 class="tp-product-title-5">
              <a href="product-details.php">Livre : L’art du plaisir</a>
            </h3>
            <div class="tp-product-price-wrapper-5">
              <span class="tp-product-price-5 new-price">7 000 FCFA</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="tp-product-item-5 p-relative white-bg mb-30">
          ...
          <div class="tp-product-thumb-5 w-img fix mb-15">
            <a href="product-details.php?id=3">
              <img src="assets/img/product/vibro.jpg" alt="Stimulateur discret">
            </a>
            <div class="tp-product-action-2 tp-product-action-5 tp-product-action-greenStyle">
              <div class="tp-product-action-item-2 d-flex flex-column">
          ...
          <div class="tp-product-content-5">
            <h3 class="tp-product-title-5">
              <h3 class="tp-product-title-5"><a href="product-details.php?id=3">Stimulateur discret</a></h3>
            </h3>
            <div class="tp-product-price-wrapper-5">
              <span class="tp-product-price-5 new-price">18 000 FCFA</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="tp-product-item-5 p-relative white-bg mb-30">
          ...
          <div class="tp-product-thumb-5 w-img fix mb-15">
            <a href="product-details.php?id=4">
              <img src="assets/img/product/Huile chaude.png" alt="Huile chaude parfumée">
            </a>
            <div class="tp-product-action-2 tp-product-action-5 tp-product-action-greenStyle">
              <div class="tp-product-action-item-2 d-flex flex-column">
          ...
          <div class="tp-product-content-5">
            <h3 class="tp-product-title-5">
              <h3 class="tp-product-title-5"><a href="product-details.php?id=4">Huile chaude parfumée</a></h3>
            </h3>
            <div class="tp-product-price-wrapper-5">
              <span class="tp-product-price-5 new-price">5 500 FCFA</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="tp-product-item-5 p-relative white-bg mb-30">
          ...
          <div class="tp-product-thumb-5 w-img fix mb-15">
            <a href="product-details.php?id=5">
              <img src="assets/img/product/menottes-de-bandes-de-lits-a-main-cuffs-ankle-cuff.webp" alt="Bracelets pour jeux">
            </a>
            <div class="tp-product-action-2 tp-product-action-5 tp-product-action-greenStyle">
              <div class="tp-product-action-item-2 d-flex flex-column">
                ...
                <!-- Wishlist -->
                <button type="button" class="tp-product-action-btn-2 tp-product-add-wishlist-btn" title="Ajouter à la wishlist" onclick="addToWishlist(this)" data-id="5">
                  <i class="fa fa-heart"></i>
                </button>
          ...
          <div class="tp-product-content-5">
            <h3 class="tp-product-title-5">
              <h3 class="tp-product-title-5"><a href="product-details.php?id=5">Bracelets pour jeux</a></h3>
            <div class="tp-product-price-wrapper-5">
              <span class="tp-product-price-5 new-price">6 000 FCFA</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="tp-product-item-5 p-relative white-bg mb-30">
          ...
          <div class="tp-product-thumb-5 w-img fix mb-15">
            <a href="product-details.php?id=6">
              <img src="assets/img/product/bougie.png" alt="Bougie massage vanille">
            </a>
            <div class="tp-product-action-2 tp-product-action-5 tp-product-action-greenStyle">
              <div class="tp-product-action-item-2 d-flex flex-column">
                ...
                <!-- Wishlist -->
                <button type="button" class="tp-product-action-btn-2 tp-product-add-wishlist-btn" title="Ajouter à la wishlist" onclick="addToWishlist(this)" data-id="6">
                  <i class="fa fa-heart"></i>
                </button>
          ...
          <div class="tp-product-content-5">
            <h3 class="tp-product-title-5">
              <a href="product-details.php?id=6">Bougie massage vanille</a>
            </h3>
            <div class="tp-product-price-wrapper-5">
              <span class="tp-product-price-5 new-price">9 500 FCFA</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="tp-product-item-5 p-relative white-bg mb-30">
          ...
          <div class="tp-product-thumb-5 w-img fix mb-15">
            <a href="product-details.php?id=7">
              <img src="assets/img/product/Vibrator-Woman-Clitoris-Stimulator-Sex-Toys-Sucker-G-Spot-Vibrator-Nipple-Clitoris-Sucker-Clitoral-Sucking-Vibrator-Vagina-Sucker-Air-Pulse-Stimulator.avif" alt="Mini masseur connecté">
            </a>
            <div class="tp-product-action-2 tp-product-action-5 tp-product-action-greenStyle">
              <div class="tp-product-action-item-2 d-flex flex-column">
                ...
                <!-- Wishlist -->
                <button type="button" class="tp-product-action-btn-2 tp-product-add-wishlist-btn" title="Ajouter à la wishlist" onclick="addToWishlist(this)" data-id="7">
                  <i class="fa fa-heart"></i>
                </button>
          ...
          <div class="tp-product-content-5">
            <h3 class="tp-product-title-5">
              <a href="product-details.php?id=7">Mini masseur connecté</a>
            </h3>
            <div class="tp-product-price-wrapper-5">
              <span class="tp-product-price-5 new-price">27 000 FCFA</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="tp-product-item-5 p-relative white-bg mb-30">
          ...
          <div class="tp-product-thumb-5 w-img fix mb-15">
            <a href="product-details.php?id=8">
              <img src="assets/img/product/lingerie1.webp" alt="Lingerie en dentelle noire">
            </a>
            <div class="tp-product-action-2 tp-product-action-5 tp-product-action-greenStyle">
              <div class="tp-product-action-item-2 d-flex flex-column">
                ...
                <!-- Wishlist -->
                <button type="button" class="tp-product-action-btn-2 tp-product-add-wishlist-btn" title="Ajouter à la wishlist" onclick="addToWishlist(this)" data-id="8">
                  <i class="fa fa-heart"></i>
                </button>
          ...
          <div class="tp-product-content-5">
            <h3 class="tp-product-title-5">
              <a href="product-details.php?id=8">Lingerie en dentelle noire</a>
            </h3>
            <div class="tp-product-price-wrapper-5">
              <span class="tp-product-price-5 new-price">14 000 FCFA</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="tp-product-item-5 p-relative white-bg mb-30">
          ...
          <div class="tp-product-thumb-5 w-img fix mb-15">
            <a href="product-details.php?id=9">
              <img src="assets/img/product/trousse-toilette.png" alt="Trousse de voyage intime">
            </a>
            <div class="tp-product-action-2 tp-product-action-5 tp-product-action-greenStyle">
              <div class="tp-product-action-item-2 d-flex flex-column">
          ...
          <div class="tp-product-content-5">
            <h3 class="tp-product-title-5">
              <a href="product-details.php?id=9">Trousse de voyage intime</a>
            </h3>
            <div class="tp-product-price-wrapper-5">
              <span class="tp-product-price-5 new-price">11 000 FCFA</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="tp-product-item-5 p-relative white-bg mb-30">
          ...
          <div class="tp-product-thumb-5 w-img fix mb-15">
            <a href="product-details.php?id=10">
              <img src="assets/img/product/lingerie3.avif" alt="Ensemble rouge passion">
            </a>
            <div class="tp-product-action-2 tp-product-action-5 tp-product-action-greenStyle">
              <div class="tp-product-action-item-2 d-flex flex-column">
                ...
                <!-- Wishlist -->
                <button type="button" class="tp-product-action-btn-2 tp-product-add-wishlist-btn" title="Ajouter à la wishlist" onclick="addToWishlist(this)" data-id="10">
                  <i class="fa fa-heart"></i>
                </button>
          ...
          <div class="tp-product-content-5">
            <h3 class="tp-product-title-5">
              <a href="product-details.php?id=10">Ensemble rouge passion</a>
            </h3>
            <div class="tp-product-price-wrapper-5">
              <span class="tp-product-price-5 new-price">16 500 FCFA</span>
            </div>
          </div>
        </div>
      </div>
                     ...
                     <div class="row">
                        <div class="col-xl-7 offset-xl-3">
                           <div class="tp-section-title-wrapper-5 mb-45">
                              ...
                              <h3 class="tp-section-title-5">Nos clients satisfaits</h3>
                           </div>
                        </div>
                     </div>
                              ...
                              <div class="tp-testimonial-item-5 d-md-flex swiper-slide white-bg">
                                 <div class="tp-testimonial-avater-wrapper-5 p-relative">
                                    <div class="tp-avater-rounded mr-60">
                                       <div class="tp-testimonial-avater-5 " style="height: fit-content;">
                                          <img src="assets/img/users/avatar3.jpg" alt="">
                                       </div>
                                    </div>
                                 ...
                                 <div class="tp-testimonial-content-5">
                                    ...
                                    <p>J'adore cette boutique ; les produits sont de qualité et la discrètion est au rendez-vous.</p>

                                    <div class="tp-testimonial-user-5-info">
                                       <h3 class="tp-testimonial-user-5-title">@super_woman</h3>
                                       <span class="tp-testimonial-user-5-designation">Angré, Abidjan</span>
                                    </div>
                                 </div>
                              </div>
                              <div class="tp-testimonial-item-5 d-md-flex swiper-slide white-bg">
                                 <div class="tp-testimonial-avater-wrapper-5 p-relative">
                                    <div class="tp-avater-rounded mr-60">
                                       <div class="tp-testimonial-avater-5 ">
                                          <img src="assets/img/users/avatar2.webp" alt="">
                                       </div>
                                    </div>
                                    <span class="quote-icon">
                                       <img src="assets/img/testimonial/testimonial-quote-2.png" alt="">
                                 ...
                                 <div class="tp-testimonial-content-5">
                                    ...
                                    <p>Généralement, j'ai une expérience client incroyable avec cette entreprise, y compris pour un achat, un retour ou une simple conversation avec le service client.</p>

                                    <div class="tp-testimonial-user-5-info">
                                       <h3 class="tp-testimonial-user-5-title">yoro_chinois</h3>
                                       <span class="tp-testimonial-user-5-designation">Yopougon, Abidjan</span>
                                    </div>
                                 </div>
                              </div>
                              <div class="tp-testimonial-item-5 d-md-flex swiper-slide white-bg">
                                 <div class="tp-testimonial-avater-wrapper-5 p-relative">
                                    <div class="tp-avater-rounded mr-60">
                                       <div class="tp-testimonial-avater-5 ">
                                          <img src="assets/img/users/avatar1.png" alt="">
                                       </div>
                                    </div>
                                    <span class="quote-icon">
                                       <img src="assets/img/testimonial/testimonial-quote-2.png" alt="">
                                 ...
                                 <div class="tp-testimonial-content-5">
                                    ...
                                    <p>Enfin une boutique qui respecte la confidentialité. Merci à vous !</p>

                                    <div class="tp-testimonial-user-5-info">
                                       <h3 class="tp-testimonial-user-5-title">@zahia_marcory</h3>
                                       <span class="tp-testimonial-user-5-designation">Zone 4, Abidjan</span>
                                    </div>
                                 </div>
                              </div>
                           </div>
                        ...
                        <div class="tp-testimonial-arrow-5">
                           <button type="button" class="tp-testimonial-slider-5-button-prev">
                              <svg width="33" height="16" viewBox="0 0 33 16" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                 <path d="M2.10059 7.97559L32.1006 7.97559" stroke="currentColor" stroke-width="1.5"
                           ...
                           <button type="button" class="tp-testimonial-slider-5-button-next">
                              <svg width="33" height="16" viewBox="0 0 33 16" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                 <path d="M31.1006 7.97559L1.10059 7.97559" stroke="currentColor" stroke-width="1.5"
                                    stroke-linecap="round" stroke-linejoin="round" />
                           ...
                           <div class="tp-best-banner-item-5 p-relative fix swiper-slide">
                              <a href="shop.php">
                                 <div class="tp-best-banner-thumb-5 include-bg grey-bg"
                                    data-background="assets/img/slider/5/slider-2-cropped.png"></div>
                              </a>
                           </div>
                           <div class="tp-best-banner-item-5 p-relative fix swiper-slide">
                              <a href="shop.php">
                                 <div class="tp-best-banner-thumb-5 include-bg grey-bg"
                                    data-background="assets/img/product/menottes-de-bandes-de-lits-a-main-cuffs-ankle-cuff.webp"></div>
                              </a>
                           </div>
                           <div class="tp-best-banner-item-5 p-relative fix swiper-slide">
                              <a href="shop.php">
                                 <div class="tp-best-banner-thumb-5 include-bg grey-bg"
                                    data-background="assets/img/product/6.png"></div>
                              </a>
                           </div>
                        </div>
                     </div>
               ...
               <div class="col-xl-9 col-lg-8 col-md-7">
                  <div class="tp-best-slider-wrapper-5">
                     <div class="tp-section-title-wrapper-5 mb-35">
                        ...
                        <h3 class="tp-section-title-5">Meilleures ventes de la semaine</h3>
                     </div>
                           ...
                           <div class="swiper-wrapper">
                                 ...
                                 <div class="tp-product-item-5 p-relative white-bg mb-40">
                                       ...
                                       <div
                                          ...
                                          <div class="tp-product-action-item-2 d-flex flex-column">
                                             <button type="button"
                                                ...
                                                <span class="tp-product-tooltip tp-product-tooltip-right">Ajouter à Carte</span>
                                             </button>
                                             <button type="button"
                                                ...
                                                <span class="tp-product-tooltip tp-product-tooltip-right">Vue Rapide</span>
                                             </button>
                                             <button type="button"
                                                ...
                                                <span class="tp-product-tooltip tp-product-tooltip-right">Ajouter à
                                                   Wishlist</span>
                                             </button>
                                             <button type="button"
                                    ...
                                    <div class="tp-product-content-5">
                                       <div class="tp-product-tag-5">
                                          <span><a href="#">Accessoires, </a></span>
                                          <span><a href="#">Bien-Être</a></span>
                                       </div>
                                       <h3 class="tp-product-title-5">
                                          <a href="product-details.php?id=2">Livre : L’art du plaisir</a>
                                       </h3>
                                       ...
                                       <div class="tp-product-price-wrapper-5">
                                          <span class="tp-product-price-5 new-price">7 000 FCFA</span>
                                          <span class="tp-product-price-5 old-price">10 000 FCFA</span>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                              <div class="tp-best-item-5 swiper-slide">
                                 <div class="tp-product-item-5 p-relative white-bg mb-40">
                                    <div class="tp-product-thumb-5 w-img fix mb-15">
                                       <a href="product-details.php?id=5">
                                          <img src="assets/img/product/menottes-de-bandes-de-lits-a-main-cuffs-ankle-cuff.webp" alt="">
                                       </a>
                                    ...
                                    <div class="tp-product-content-5">
                                       ...
                                       <h3 class="tp-product-title-5">
                                          <a href="product-details.php?id=5">Bracelets pour jeux</a>
                                       </h3>
                                       <div class="tp-product-rating-5">
                                          <span><i class="fa-solid fa-star"></i></span>
                                          <span><i class="fa-solid fa-star"></i></span>
                                       ...
                                       <div class="tp-product-price-wrapper-5">
                                          <span class="tp-product-price-5 new-price">6 000 FCFA</span>
                                          <span class="tp-product-price-5 old-price">9 000 FCFA</span>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                  ...
                  <div class="col-xl-3 col-lg-3 col-sm-6">
                     <div class="tp-feature-item-5 d-flex align-items-center">
                        <div class="tp-feature-icon-5">
                           <span>
                              <svg width="28" height="24" viewBox="0 0 28 24" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                 <path d="M18.7273 1H1V16.8893H18.7273V1Z" stroke="currentColor" stroke-width="1.5"
                                    stroke-linecap="round" stroke-linejoin="round" />
                                 <path d="M18.7266 7.11133H23.4538L26.9993 10.7781V16.8894H18.7266V7.11133Z"
                                    stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                    stroke-linejoin="round" />
                                 <path
                        ...
                        <div class="tp-feature-content-5">
                           <h3 class="tp-feature-title-5">Livraison discrète</h3>
                        </div>
                     </div>
                  </div>
                  <div class="col-xl-3 col-lg-3 col-sm-6">
                     <div class="tp-feature-item-5 d-flex align-items-center">
                        <div class="tp-feature-icon-5">
                           <span>
                              <svg width="16" height="28" viewBox="0 0 16 28" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                 <path d="M8 1.5V26.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                    stroke-linejoin="round" />
                                 <path
                        ...
                        <div class="tp-feature-content-5">
                           <h3 class="tp-feature-title-5">100% Remboursé</h3>
                        </div>
                     </div>
                  </div>
                  <div class="col-xl-3 col-lg-3 col-sm-6">
                        ...
                        <div class="tp-feature-icon-5">
                           <span>
                              <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                 <path d="M3.12305 16.2651L16.268 3.12012" stroke="currentColor" stroke-width="1.5"
                                    stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                 <path d="M11.0117 18.9055L12.3317 17.5854" stroke="currentColor" stroke-width="1.5"
                                    stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                 <path d="M13.9727 15.9464L16.6017 13.3174" stroke="currentColor" stroke-width="1.5"
                                    stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                 <path
                                    ...
                                    stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                    stroke-linejoin="round" />
                                 <path d="M1 22.9971H23" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                    stroke-linejoin="round" />
                              </svg>
                           </span>
                        </div>
                        <div class="tp-feature-content-5">
                           <h3 class="tp-feature-title-5">Paiement Sûr</h3>
                        </div>
                     </div>
                  </div>
                  <div class="col-xl-3 col-lg-3 col-sm-6">
                     <div class="tp-feature-item-5 d-flex align-items-center">
                        ...
                        <div class="tp-feature-content-5">
                           <h3 class="tp-feature-title-5">Service client 24/24</h3>
                        </div>
                     </div>
                  </div>
               </div>
      ...
      <section class="tp-cta-area fix pt-50 p-relative z-index-1">
         <div class="tp-cta-inner p-relative pt-80 pb-55" data-bg-color="#E44C76">
               ...
               <div class="row">
                  <div class="col-xl-6 col-lg-6 col-md-7">
                     <div class="tp-cta-wrapper p-relative z-index-1">
                        <h3 class="tp-cta-title">Télécharge l'appli</h3>
      ...
      <div class="modal fade tp-product-modal tp-product-modal-styleGreen" id="producQuickViewModal" tabindex="-1"
                     ...
                     <div class="tp-product-details-action-wrapper">
                        ...
                        <div class="tp-product-details-action-item-wrapper d-sm-flex align-items-center">
                           ...
                           <div class="tp-product-details-add-to-cart mb-15 w-100">
                              <button class="tp-product-details-add-to-cart-btn w-100">Ajouter à Cart</button>
                           </div>
                        </div>
...
<script>
  ...
  function addToWishlist(button) {
    const id = button.getAttribute('data-id');
    fetch(`add_to_wishlist.php?id=${id}`)
      .then(res => res.json())
      .then(data => {
        if (data.success) {
          document.querySelector('.wishlist-count').innerText = data.total;
        }
      })
        .catch(error => {
